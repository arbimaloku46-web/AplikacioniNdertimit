...
export function InteractiveViewer({ data, onClose }: InteractiveViewerProps) {
  ...
  return (
    <div className="w-full h-[100dvh] bg-slate-950 overflow-hidden flex flex-col relative font-sans">
        
        {/* Navigation Header */}
        <div className="h-16 px-4 sm:px-6 border-b border-white/5 flex items-center justify-between bg-slate-900/50 backdrop-blur-md shrink-0 relative z-10">
