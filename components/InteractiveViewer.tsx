      ...
      <div className="flex-1 relative flex bg-slate-900/50 min-h-[500px] overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          {level === 'exterior' && (
            ...
            >
              <div className="relative flex items-center justify-center min-h-0 min-w-0 max-w-full max-h-full rounded-2xl overflow-hidden shadow-2xl" style={{ lineHeight: 0 }}>
                <img 
          ...
          {level === 'floor' && activeFloor && (
            ...
            >
              <div className="w-full md:w-3/4 h-[50vh] md:h-full flex items-center justify-center p-4 md:p-8 relative bg-slate-950/50 shrink-0 min-w-0 min-h-0 overflow-hidden">
                <div className="relative flex items-center justify-center min-h-0 min-w-0 max-w-full max-h-full rounded-2xl overflow-hidden shadow-2xl bg-white" style={{ lineHeight: 0 }}>
                  <img 
          ...
          {level === 'unit' && activeUnit && (
            ...
            >
              <div className="w-full md:w-2/3 h-[50vh] md:h-full p-6 md:p-12 flex items-center justify-center bg-white shrink-0 min-w-0 min-h-0 overflow-hidden">
                <div className="relative flex items-center justify-center min-h-0 min-w-0 max-w-full max-h-full" style={{ lineHeight: 0 }}>
                  <img 
